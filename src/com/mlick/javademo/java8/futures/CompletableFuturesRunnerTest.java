package com.mlick.javademo.java8.futures;

import com.mlick.javademo.java8.futures.example.StringInputTask;
import com.mlick.javademo.java8.futures.example.StringResults;
...
//        BasicConfigurator.configure();
    ...
    public void testGo() {
        ...
        final WaitingFuturesRunner<String, String> completableFuturesRunner = new WaitingFuturesRunner<>(taskList, 13, TimeUnit.SECONDS);
